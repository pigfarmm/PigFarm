...
//    SwipeRefreshLayout mySwipeRefreshLayout;
    ...
    @Override
        ...
        txt_about.setText("รายงานประสิทธิภาพกลุ่มผสม");
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WebView_GroupBredder.this, Report_GroupBredder.class);
    ...
    private class ShowPDF extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                WebView_GroupBredder.this.runOnUiThread(new Runnable() {
                    public void run() {
