...
public class WebView_AllPerformance extends AppCompatActivity {

    String farm_id,last_day,range,ip_number,ip_type , showtype;
...
//    SwipeRefreshLayout mySwipeRefreshLayout;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        txt_about.setText("รายงานประสิทธิภาพโดยรวม");
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WebView_AllPerformance.this, Report_AllPerformance.class);
    ...
    private class ShowPDF extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                WebView_AllPerformance.this.runOnUiThread(new Runnable() {
                    public void run() {
                        pDialog = new ProgressDialog(WebView_AllPerformance.this);
