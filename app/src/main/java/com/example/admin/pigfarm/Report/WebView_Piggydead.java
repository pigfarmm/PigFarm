...
public class WebView_Piggydead extends AppCompatActivity {

    String farm_id,start_date,end_date,last_day,ip_number,ip_type,range,showtype;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        txt_about.setText("รายงานลูกหมูตาย");
    ...
    private class ShowPDF extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                WebView_Piggydead.this.runOnUiThread(new Runnable() {
                    public void run() {
                        pDialog = new ProgressDialog(WebView_Piggydead.this);
