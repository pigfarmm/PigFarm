...
public class edt_Entrustment_Fragment extends Fragment {
    ...
    String get_detail_id,getfarm_id,event_recorddate,event_name,pig_amountofentrustment,getunit_id;
    EditText edt_eventname,edit_dateNote05,edit_numbaby05;
    ...
    private void QueryDataEntrustment(String response) {
        try {
            ...
            btn_flacAct05.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    GetDataFromEditText();
                    update_data(event_recorddate, pig_amountofentrustment,get_detail_id);
                }
            });
    ...
    private void update_data(String event_recorddate, String pig_amountofentrustment, String get_detail_id) {
        ...
        update_dataclass.execute(get_detail_id,event_recorddate,pig_amountofentrustment);
