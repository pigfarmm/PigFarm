...
//            rotatedBitmap.compress(Bitmap.CompressFormat.JPEG,70,bs);
//            intent.putExtra("byteArray",bs.toByteArray());
//            startActivity(intent);

            Intent intent = new Intent(getActivity(),PictureActivity2.class);
            intent.putExtra("path2",mFile.toString());
            startActivity(intent);
