...
public class WebView_MomGiveBirth extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        txt_about.setText("แม่พันธุ์ที่เข้าคลอด");
        ...
        if (condition_one.equals("ลูกเป็น")){
            condition_one = "pig_alive";
        }else if(condition_one.equals("ลูกตาย")){
            condition_one = "pig_die";
        }else if (condition_one.equals("ลูกกรอก")){
            condition_one = "pig_seedlings";
        }else if (condition_one.equals("นน.ครอก")){
            condition_one = "pig_allweight";
        }else if (condition_one.equals("เฉลี่ย นน.แรกเกิด")){
            condition_one = "avg_pig_allweight";
        }else if (condition_one.equals("ลำดับท้อง")){
            condition_one = "preglist";
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WebView_MomGiveBirth.this, Report_Exclude.class);
    ...
    private class ShowPDF extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                WebView_MomGiveBirth.this.runOnUiThread(new Runnable() {
                    public void run() {
                        pDialog = new ProgressDialog(WebView_MomGiveBirth.this);
