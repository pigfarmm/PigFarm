...
public class edt_Getsick_Fragment extends Fragment {
    ...
    String get_detail_id,getfarm_id,event_recorddate,event_name,disease_name,note;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.edt_getsick_evt, container, false);
    }
    ...
    private void QueryDataGetsick(String response) {
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                edit_dateNote20.setText(event_recorddate);
                edit_msg20.setText(note);
