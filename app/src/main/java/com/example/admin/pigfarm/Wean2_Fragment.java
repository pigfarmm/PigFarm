...
public class Wean2_Fragment extends Fragment {
    ...
    EditText edit_dateNote17,edit_numbaby17,edit_weight17,edit_imgpro;
    Spinner spin_noteId17;
    ImageView img_calNote17,img_process;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null){
            ...
            Toast.makeText(getActivity(), "แยกหย่านม", Toast.LENGTH_SHORT).show();
        }
        ...
        img_process.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("fragment_id","13");
                editor.commit();
