...
public class Treat_Fragment extends Fragment {
    public static String gettextbreed,farm_id;
    ArrayList<String> list = new ArrayList<>();
    ArrayList<String> listItems = new ArrayList<>();
    ArrayAdapter<String> adapter;
    EditText edit_dateNote19,edit_drugG19,edit_msg19,edit_imgpro;
    Spinner spin_noteId19,spin_drugId01;
    ImageView img_calNote19,img_process;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.frag_act19, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null){
            ...
            Toast.makeText(getActivity(), "ได้รับยารักษา", Toast.LENGTH_SHORT).show();
        }

        edit_dateNote19 = getView().findViewById(R.id.edit_dateNote19);
        spin_noteId19 = getView().findViewById(R.id.spin_noteId19);
        ...
        btn_flacAct19.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new InsertAsyn().execute("https://pigaboo.xyz/Insert_EventDrugGroup.php");
            }
        });
        ...
        img_process.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("fragment_id","14");
                editor.commit();
    ...
    DatePickerDialog.OnDateSetListener date = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
            ...
            edit_dateNote19.setText(year+"-"+m+"-"+d);
        }
    };
    ...
    public void showJSON(String response){
        ...
        spin_noteId19.setAdapter(adapter);
    }
}
