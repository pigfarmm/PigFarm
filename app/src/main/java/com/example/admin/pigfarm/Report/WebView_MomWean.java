...
public class WebView_MomWean extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        txt_about.setText("แม่พันธุ์ที่หย่านม");
        ...
        if (condition_one.equals("จำนวนหย่านม")){
            condition_one = "count_wean";
        }else if(condition_one.equals("นน.หย่านม")){
            condition_one = "weight_wean";
        }else if (condition_one.equals("ระยะเลี้ยงลูก")){
            condition_one = "age_wean";
        }else if (condition_one.equals("ลำดับท้อง")){
            condition_one = "preglist_wean";
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WebView_MomWean.this, Report_Exclude.class);
    ...
    private class ShowPDF extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                WebView_MomWean.this.runOnUiThread(new Runnable() {
                    public void run() {
                        pDialog = new ProgressDialog(WebView_MomWean.this);
