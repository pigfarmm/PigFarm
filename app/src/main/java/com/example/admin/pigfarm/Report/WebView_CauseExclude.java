...
public class WebView_CauseExclude extends AppCompatActivity {
...
//    SwipeRefreshLayout mySwipeRefreshLayout;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        txt_about.setText("รายงานสาเหตุการคัดทิ้ง");
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WebView_CauseExclude.this, Report_CauseExclude.class);
    ...
    private class ShowPDF extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                WebView_CauseExclude.this.runOnUiThread(new Runnable() {
                    public void run() {
                        pDialog = new ProgressDialog(WebView_CauseExclude.this);
